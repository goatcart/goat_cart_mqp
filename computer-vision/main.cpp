...
int main (int argc, char** argv )
{
    ...
    for (;;)
    {
        ...
        if (ready)
        {
            ...
            putText(disp_vis, tm_disp, Point(10, 100), FONT_HERSHEY_PLAIN, 2.0, cv::Scalar(255.0, 255.0, 255.0), 2);
            putText(disp_vis, tm_cap, Point(10, 200), FONT_HERSHEY_PLAIN, 2.0, cv::Scalar(255.0, 255.0, 255.0), 2);
